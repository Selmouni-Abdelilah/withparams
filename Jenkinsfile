                ...
                script {
                    withCredentials([azureServicePrincipal(credentialsId: 'Azure_credentials',
                        ...
                        if (params.VM_CHOICE == "Linux VM") {
                            sh "terraform import azurerm_logic_app_standard.logicapp /subscriptions/${SUBS_ID}/resourceGroups/rg_abdel_proc/providers/Microsoft.Compute/virtualMachines/LinuxVM"
                        }
                        else {
                            sh "terraform import azurerm_logic_app_workflow.workflow /subscriptions/${SUBS_ID}/resourceGroups/rg_abdel_proc/providers/Microsoft.Compute/virtualMachines/windows-VM"
                        }
                    }
                }
            }
